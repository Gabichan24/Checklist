...
<head>
    ...
    {{-- Vite SIEMPRE va dentro del <head> --}}
    @vite(['resources/css/app.css', 'resources/js/app.js'])

    {{-- Scripts externos SIEMPRE van DESPUÉS de Vite --}}
...
<body class="h-full flex">
    ...
    <aside class="w-64 fixed h-full bg-white border-r shadow-lg">
        ...
        <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
            ...
            <a href="#" class="flex items-center gap-3 px-4 py-2 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600">👁 Monitores</a>
            <a href="#" class="flex items-center gap-3 px-4 py-2 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600">⚠ Incidencias</a>
        ...
        <div class="p-4 border-t">
            <a href="#" class="flex items-center gap-3 px-4 py-2 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 w-full">⚙ Configuraciones</a>
        </div>
    </aside>
